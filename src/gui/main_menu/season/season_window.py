...
def _season_selection_layout():
    return [
        [
            sg.Button("New Season", expand_x=True, expand_y=True),
            sg.Button("Load Season", expand_x=True, expand_y=True),
            sg.Button("Delete Season", expand_x=True, expand_y=True),
